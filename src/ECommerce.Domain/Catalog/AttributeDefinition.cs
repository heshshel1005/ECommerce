...
using ECommerce.Catalog.Events;
using Volo.Abp;
...
public class AttributeDefinition : AuditedAggregateRoot<Guid>, IMultiTenant, ICatalogTaxonomyEntity
{
    ...
    public void SubmitForReview()
    {
        ...
        {
            throw new BusinessException(ECommerce.ECommerceDomainErrorCodes.AttributeDefinitionInvalidGovernanceTransition)
    ...
    private void EnsureNotArchivedForMutation()
    {
        if (GovernanceStatus == AttributeDefinitionGovernanceStatus.Archived)
        {
            throw new BusinessException(ECommerce.ECommerceDomainErrorCodes.AttributeDefinitionArchivedMutationBlocked);
        }
    }
