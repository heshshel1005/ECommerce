...
public class ProductTypeAttributeRule : AuditedAggregateRoot<Guid>, IMultiTenant, ICatalogTaxonomyEntity
{
    ...
    {
        var normalizedKey = NormalizeOptional(conditionalAttributeKey, ECommerceConsts.Catalog.ProductTypeRuleMaxConditionAttributeKeyLength, nameof(conditionalAttributeKey));
        var normalizedExpectedValue = NormalizeOptional(conditionalExpectedValue, ECommerceConsts.Catalog.ProductTypeRuleMaxConditionExpectedValueLength, nameof(conditionalExpectedValue));
...
public enum ProductTypeRuleConditionOperator
{
    Equals = 0,
    NotEquals = 1,
    Contains = 2,
