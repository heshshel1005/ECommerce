...
public class AttributeDefinitionTranslation : Entity<Guid>, IMultiTenant
{
    ...
    {
        Language = NormalizeRequired(language, ECommerceConsts.Catalog.TranslationLanguageMaxLength, nameof(language));
    }

    public void SetDisplayName(string displayName)
    {
        DisplayName = NormalizeRequired(displayName, ECommerceConsts.Catalog.AttributeDefinitionTranslationDisplayNameMaxLength, nameof(displayName));
    }

    public void SetDescription(string? description)
    {
        Description = NormalizeOptional(description, ECommerceConsts.Catalog.AttributeDefinitionTranslationDescriptionMaxLength, nameof(description));
    }
