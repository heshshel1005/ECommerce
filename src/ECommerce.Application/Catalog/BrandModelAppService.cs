...
public class BrandModelAppService : ECommerceAppService, IBrandModelAppService
{
    ...
    [Authorize(ECommercePermissions.Catalog.Default)]
    ...
    [Authorize(ECommercePermissions.Catalog.BrandModels)]
