...
/// <summary>
/// Reserves (increment Reserved) and releases (decrement Reserved) inventory for cart flow.
/// </summary>
public class InventoryReservationService : ECommerceAppService, IInventoryReservationService
{
