...
public class AttributeDefinitionAppService : ECommerceAppService, IAttributeDefinitionAppService
{
    ...
    public async Task<AttributeDefinitionDto> UpdateAsync(Guid id, UpdateAttributeDefinitionDto input)
    {
        ...
        {
            throw new BusinessException(ECommerceDomainErrorCodes.AttributeDefinitionArchivedMutationBlocked);
        }
    ...
    [Authorize(ECommercePermissions.Catalog.AttributeDefinitionsReview)]
    ...
    [Authorize(ECommercePermissions.Catalog.AttributeDefinitionsPublish)]
        ...
        SaveAttributeOptionTranslationsDto input)
    {
        ...
        foreach (var option in input.Options)
        {
            ...
            {
                throw new BusinessException(ECommerceDomainErrorCodes.AttributeOptionTranslationUnknownValue)
            ...
            if (translations.Count > 0)
            {
                MultilingualDomainGuard.ValidateRequiredDefaultAndNoDuplicates(
                    ...
                    defaultLanguage,
                    ECommerceDomainErrorCodes.AttributeOptionTranslationDuplicateLanguage,
                    ECommerceDomainErrorCodes.AttributeOptionTranslationDefaultRequired);
            }
