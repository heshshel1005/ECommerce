...
public class ProductTypeAttributeRuleAppService : ECommerceAppService, IProductTypeAttributeRuleAppService
{
    ...
    public async Task ReplaceForProductTypeAsync(Guid productTypeId, List<UpdateProductTypeAttributeRuleDto> input)
    {
        ...
        if (definitionIds.Count > 0)
        {
            ...
            {
                throw new BusinessException(ECommerceDomainErrorCodes.AttributeDefinitionMustBePublishedForProductTypeRules)
